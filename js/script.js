...
function createCard(city) {
  ...
  DIV_PEOPLE.textContent = city.nbResidents
    ? city.nbResidents.toLocaleString() + " habitants"
    : "Donnée inconnue";
...
SELECT_CARDS.addEventListener("change", () => {
  ...
  if (SELECTED_CONTINENT === "") {
    ...
    const CITIES_IN_CONTINENT = CITIES.filter(
      (city) => city.continent === SELECTED_CONTINENT,
    );
